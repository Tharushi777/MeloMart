...
import lk.javainstitute.melo.adapter.AddressAdapter;
...
public class AddressActivity extends AppCompatActivity implements AddressAdapter.SelectedAddress {
 ...
 FirebaseAuth auth;
 Button addAddAddress,paymentbtn;
 Toolbar toolbar;
 String mAddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(obj instanceof PopulatProModel){
                    PopulatProModel populatProModel=(PopulatProModel) obj;
                    amount= populatProModel.getPrice();
                }
